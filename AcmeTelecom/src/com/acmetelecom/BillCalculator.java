...
public class BillCalculator {
	...
	public BigDecimal calculate(Call call, Tariff tariff) {
		...
		BigDecimal peakCharge = new BigDecimal(peak).multiply(tariff.peakRate());
		BigDecimal offPeakCharge = new BigDecimal(offPeak).multiply(tariff.offPeakRate());
